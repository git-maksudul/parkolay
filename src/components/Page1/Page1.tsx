    ...
    return (
        <div className='lg:mx-96'>
            <div className="font-inter lg:flex lg:-ml-[200px] mt-8 lg:mt-0">
                ...
                <div className='flex gap-5 lg:gap-5 lg:grid lg:w-1/8 mt-6 lg:mt-0 lg:-mx-[25px]'>
            ...
            <div className='mt-5 lg:mt-10 flex justify-center lg:justify-end mx-0 lg:-mx-[245px]'>
