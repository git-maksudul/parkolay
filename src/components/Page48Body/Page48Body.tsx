import img1 from '../../../public/images/page48/Rectangle.png'
...
const Page48Body = () => {
    ...
    return (
        <div className='lg:mx-96'>
            ...
            <div className='mt-9 lg:mt-5 flex justify-center lg:justify-end mx-0 lg:-mx-[265px]'>
