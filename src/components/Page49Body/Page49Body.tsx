import img1 from '../../../public/images/page49/Rectangle.png'
...
const Page49Body = () => {
    ...
    return (
        <div className='lg:mx-96'>
            ...
            <div className='mt-9 lg:mt-2 flex justify-center lg:justify-end mx-0 lg:-mx-[265px]'>
