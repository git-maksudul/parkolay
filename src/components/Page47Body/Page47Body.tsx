import img1 from '../../../public/images/page47/Rectangle.png'
...
const Page47Body = () => {
    ...
    return (
        <div className='lg:mx-96'>
            <div className="font-inter lg:flex lg:-ml-[200px] mt-7 lg:mt-0">
                <div className=' w-full mx-auto lg:mt-4 lg:mx-14'>
                    <img className='lg:-mx-26 lg:w-[108%] lg:h-[105%] lg:max-w-[1000px]' src={img1} alt="" />
                </div>
