import img1 from '../../../public/images/page44/Rectangle.png'
...
const Page44Body = () => {
    ...
    return (
        <div className='lg:mx-96'>
            ...
            <div className='mt-9 lg:mt-5 flex justify-center lg:justify-end mx-0 lg:-mx-[273px]'>
                ...
                <div className='lg:mt-10 mt-6 flex items-center lg:gap-[73px] gap-8 lg:mx-18 -ml-18'>
                    <div>
                        ...
                        <div className='flex items-baseline gap-1 lg:gap-2 mt-2 lg:mt-3'>
                            ...
                            <p className='lg:text-[25px] font-semibold'>6</p>
                        </div>
                    </div>
                    <div className='lg:mt-4'>
                        ...
                        <div className='flex items-baseline gap-1 lg:gap-2 mt-3 lg:mt-4'>
                            ...
                            <p className='lg:text-[25px] font-semibold'>196</p>
                        </div>
                    </div>
                </div>
            </div>
